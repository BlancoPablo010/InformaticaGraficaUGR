...
int _PLY_object3D::open(const string &File_name)
{
...
void _PLY_object3D::get_token(istringstream &Line_stream1,string &Token1)
{
...
bool _PLY_object3D::get_new_line(ifstream &File,istringstream &Line_stream)
{
    string Line;
...
void _PLY_object3D::read(vector<float> &Coordinates, vector<unsigned int> &Positions)
{
    string Token;
